...
(function() {
  ...
  _.reject = function(collection, test) {
    ...
    var result = [];
    result = _.filter(collection,function(arg){
        return !test(arg); 
      }); 
    return result; 
  };
  ...
  _.memoize = function(func) {
    ...
    return function() { 
      ...
      var argName = Array.prototype.join.call(arguments) + ' @@ ' +arguments.length ; 
      if(funcObj.args[argName] === undefined) { 
        funcObj.args[argName] = func.apply(this,arguments); 
        //console.log(funcM);
        //console.log(func.apply(this,arguments));
      }
      return funcObj.args[argName]; 
    }; 
  };
